...
import { OpenClose } from '../hooks/openCloseToggle';


const MainPage = () => {

    const [name, setName] = useState('Straner');
    ...
    const openCloseModal = OpenClose()

   
    return (
        <>
            <Modal
                isOpen={openCloseModal.isModalOpen}
                ariaHideApp={false}
            ...
            >
                ...
                <button onClick={openCloseModal.toggleModal}>OK</button>
            </Modal>
